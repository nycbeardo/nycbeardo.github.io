            ...
            <div className="portfolio-items">
              <div className="col-sm-6 col-md-3 col-lg-3 web">
                <div className="portfolio-item">
                  <div className="hover-bg"> <a href="img/example/01-large.jpg" title="This is a technical documentation page concept, created with CSS and Node.js" rel="prettyPhoto">
